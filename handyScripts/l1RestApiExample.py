...
class TestL1Settings(object):
    ...
    def on_off_auto_negotiation(self):
        
        vport = self.ixnetwork.Vport.find(Name='port1')
        vport.L1Config.NovusHundredGigLan.EnableAutoNegotiation = True
        
        print(f"AN Enabled: {vport.L1Config.NovusHundredGigLan.EnableAutoNegotiation}")
        time.sleep(5)
